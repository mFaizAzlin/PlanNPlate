				...
				<div class="col-10">
					<div class="border-bottom border-top border-primary bg-light py-5 px-4" >
						<div class="text-center">
							...
							<h1 class="display-5 mb-5">Update Your Recipe</h1>
						</div>
						<div class="row g-4 form">
							...
							<div class="col-lg-4 col-md-6">
								<a href="#" class="button btn btn-primary rounded-pill" id="button" style="width: 150px;">Change Image</a>
							</div>	
						</div>
						...
						<div class="row g-4 form">
								...
								<div class="col-lg-4 col-md-6" >
									<input type="text" class="form-control border-primary p-2" name="title" value="<c:out value="${recipe.title}"/>" style="width: 400px;color: black;">
								</div>
								<div class="col-lg-4 col-md-6" >
										<input type="text" class="form-control border-primary p-2" name=tag value="<c:out value="${recipe.tag}"/>" style="padding-left: 35px;margin-left: 80px;color: black;">
								</div>
								...
								<div class="col-lg-4 col-md-6" ></div>
								<div class="col-lg-4 col-md-6" >
									<textarea class="form-control border-primary p-2" name="ingredient" style="width: 400px;height: 300.6px;color: black;"><c:out value="${recipe.ingredient}"/></textarea><br>
								</div>
								<div class="col-lg-4 col-md-6" style="margin-left: 80px;">
									<textarea class="form-control border-primary p-2" name="instruction"  style="width: 580.6px;height: 300.6px;color: black;"><c:out value="${recipe.instruction}"/></textarea><br>
								</div>
								
								<div class="col-12 text-center">
									<input type="submit" class="btn btn-primary px-5 py-3 rounded-pill" value="update">
								</div>
		...
		<div class="popup-content">
			...
			<form action="RecipeController" method ="post" enctype="multipart/form-data">
				<div class="col-12 text-center">
					<input type="hidden" name="userid" value="<c:out value="${sessionId}" />">
					<input type="hidden" name="recipeID" value="<c:out value="${recipe.recipeID}"/>">
					<input class="form-control border-primary p-2" type="file" name="image" style="margin-top: 30px;">
					<input type="submit"  class="btn btn-primary px-5 py-3 rounded-pill"  value="Change Image" style="margin-top: 20px;">	
				</div>
			</form>						
		</div>
	</div>
