...
<html lang="en">
						...
						<div class="border-bottom border-top border-primary bg-light py-5 px-4" >
							<div class="row g-4 form">
									...
									<div class="col-lg-4 col-md-6">
							    		...
							    		<input type="hidden" name="userID" value="<c:out value="${favorite.userID}"/>">
							    		<input type="hidden" id="favoriteID-${p.index}" value="<c:out value="${favorite.favoriteID}"/>">
							    		<button class="btn btn-danger" onclick="confirmation('${p.index}')">Remove from Favorite</button>
							    	</div>
							    	<div class="col-lg-4 col-md-6"></div>
							    	<div class="col-lg-4 col-md-6">
							      		<b>Ingredient:</b><textarea class="form-control border-primary p-2" name="ingredient" placeholder="Ingredient" style="width: 300px;height: 300.6px;color: black;"> <c:out value="${recipe.ingredient}" /></textarea><br>   
							      	</div> 
							      	<div class="col-lg-4 col-md-6">
							        	<b>Instruction:</b><textarea class="form-control border-primary p-2" name="instruction" placeholder="instruction" style="width: 670px;height: 300.6px;color: black;"><c:out value="${recipe.instruction}"/></textarea> <br><br>  
							        </div> 		     
							 </div>
						</div>
		        	</div>
    ...
    <script>
		function confirmation(index){
			  var favoriteID = $("#favoriteID-" + index).val();
			 
			  console.log(favoriteID);
			  var r = confirm("Are you sure you want to delete?");
			  if (r == true) {				 		  
				  location.href = 'FavoriteController?action=deleteFavorite&favoriteID=' + <c:out value="${favorite.favoriteID}"/> +'&userID=' + <c:out value="${favorite.userID}"/>;
