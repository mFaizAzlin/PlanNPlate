       ...
       <!-- Navbar start -->
                        ...
                        <div class="navbar-nav mx-auto">
                            ...
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu bg-light">
                                    ...
                                    <a href="FavoriteController?action=listFavoriteRecipes&userID=<c:out value="${sessionId}" />" class="nav-item nav-link active">Favorite</a>
        ...
        <div class="container-fluid bg-light py-6 my-6 mt-0">
            <div class="container text-center animated bounceInDown">
                <h1 class="display-1 mb-4">Favorites</h1>
        ...
        <div class="container-fluid event py-6">
            <div class="container">
                <div class="text-center wow bounceInUp" data-wow-delay="0.1s">
                    <small class="d-inline-block fw-bold text-dark text-uppercase bg-light border border-primary rounded-pill px-4 py-1 mb-3">Favorites</small>
                    <h1 class="display-5 mb-5">Our Recipes & Cook Guidance</h1>
                ...
                <div class="tab-content">
                	<div id="tab-1" class="tab-pane fade show p-0 active">
	                	<div class="row g-4">
	                   		<div class="col-lg-12">
	                    		<div class="row g-4">
				                	<c:forEach items="${recipe}" var="recipe" varStatus="p">
							        	<div class="col-md-6 col-lg-3 wow bounceInUp" data-wow-delay="0.1s">
							        		<div class="event-img position-relative">
							        			...
							        			<div >
							        				...
							        				<a href="FavoriteController?action=viewFavorite&recipeID=<c:out value="${recipe.recipeID}" />" class="btn btn-warning">View</a>
							        			</div>	
							        		</div>
							        	</div>
				                    </c:forEach>
