...
<body>
	...
	<div class="container-fluid bg-light py-6 my-6 mt-0"
		style="margin-bottom: 10px; padding-bottom: 40px;">
		<div class="container text-center animated bounceInDown">
			<h1 class="display-1 mb-4">Recipes</h1>
			<h5 class="breadcrumb justify-content-center mb-0 animated bounceInDown">Share Your Recipe</h5>
		</div>
	</div>
	<!-- Hero End -->
				...
				<div class="col-10">
					<div class="border-bottom border-top border-primary bg-light py-5 px-4" >
						<div class="text-center">
							<small
								class="d-inline-block fw-bold text-dark text-uppercase bg-light border border-primary rounded-pill px-4 py-1 mb-3">All Yours</small>
							<h1 class="display-5 mb-5">Add Your Recipe</h1>
						</div>
						
						<form action="RecipeController" method ="post" enctype="multipart/form-data">
						<div class="row g-4 form">
								...
								<div class="col-lg-4 col-md-6" >
									<input type="text" class="form-control border-primary p-2" name="title" placeholder="Your Recipe Name" style="width: 400px;">
								</div>
								<div class="col-lg-4 col-md-6" ></div>
								<div class="col-lg-4 col-md-6" ></div>
								
								<div class="col-lg-4 col-md-6" >
										<input type="text" class="form-control border-primary p-2" name=tag placeholder="Tag" style="padding-left: 35px;">
							
								</div>
								<div class="col-lg-4 col-md-6" style="margin-left: 7px;">
									<input class="form-control border-primary p-2" type="file" name=image >
								</div>

								<div class="col-lg-4 col-md-6" >
									<textarea class="form-control border-primary p-2" name="ingredient" placeholder="Ingredient" style="width: 400px;height: 300.6px;"></textarea><br>
								</div>
								<div class="col-lg-4 col-md-6" style="margin-left: 80px;">
									<textarea class="form-control border-primary p-2" name="instruction" placeholder="Instruction" style="width: 580.6px;height: 300.6px;"></textarea><br>
								</div>
								
								<div class="col-12 text-center">
									<input type="submit" class="btn btn-primary px-5 py-3 rounded-pill" value="submit">
								</div>
...
<script>
        document.getElementById('add-ingredient').addEventListener('click', function() {
            ...
            if (ingredient && quantity && measurement) {
                ...
                div.innerHTML = `
                    <span>${ingredient}: ${quantity} ${measurement}</span>
                    <button class="btn btn-primary btn-sm delete-ingredient" style="padding-right: 4px;padding-top: 1px;padding-left: 4px;padding-bottom: 1px;"> <i class="bi bi-x-square"></i></button>
                `;
