...
<html lang="en">
    ...
    <body>
                    ...
                    <div class="collapse navbar-collapse" id="navbarCollapse">
                        <div class="navbar-nav mx-auto">
                            ...
                            <div class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown">Personal</a>
                                <div class="dropdown-menu bg-light">
                                    <a href="RecipeController?action=listPersonalRecipe&userID=<c:out value="${sessionId}" />" class="nav-item nav-link active">Your Recipe</a>
        ...
        <div class="container-fluid bg-light py-6 my-6 mt-0">
            <div class="container text-center animated bounceInDown">
                <h1 class="display-1 mb-4">Personal Recipes</h1>
            </div>
        </div>
        <!-- Hero End -->
        ...
        <div class="container-fluid event py-6">
            <div class="container">
                <div class="text-center wow bounceInUp" data-wow-delay="0.1s">
                    <small class="d-inline-block fw-bold text-dark text-uppercase bg-light border border-primary rounded-pill px-4 py-1 mb-3">Yours</small>
                    <h1 class="display-5 mb-5">Your Recipes & Cook Guidance</h1>
                     <input type="text" id="searchInput" onkeyup="searchRecipes()" placeholder="Search for recipes..." class="form-control mb-4">
                </div>
                ...
                <div class="tab-content">
                	<div id="tab-1" class="tab-pane fade show p-0 active">
	                	<div class="row g-4">
	                   		<div class="col-lg-12">
	                    		<div class="row g-4">
				                	<c:forEach items="${recipes}" var="recipe" varStatus="p">
							        	<div class="col-md-6 col-lg-3 wow bounceInUp" data-wow-delay="0.1s">
							        		<div class="event-img position-relative">
							        			<img class="img-fluid rounded w-100" src="data:image/jpg;base64,<c:out value="${recipe.image}" />" alt="">
							        			<div >
							        				<h6><c:out value="${recipe.title}" /></h6>
							        				<small class="d-inline-block fw-bold text-dark text-uppercase bg-light border border-primary rounded-pill px-4 py-1 mb-3"><c:out value="${recipe.tag}" /></small>
							        				<a href="RecipeController?action=viewPersonalRecipe&recipeID=<c:out value="${recipe.recipeID}" />" class="btn btn-warning">View</a>
							        				<input type="hidden" name="userID" value="<c:out value="${sessionId}"/>">
							    					<input type="hidden" id="recipeID-${p.index}" value="<c:out value="${recipe.recipeID}"/>">
							    					<button class="btn btn-danger" onclick="confirmation('${p.index}')">Delete</button>
							        			</div>	
							        		</div>
							        	</div>
				                    </c:forEach>
        ...
        <div class="container-fluid event py-6">
			...
			<div class="col-12 text-center">
				<a class="btn btn-primary px-5 py-3 rounded-pill wow bounceInUp" href="RecipeController?action=addRecipe">Add New Recipe</a>
			</div>
		</div>
        </div>
        <!-- Events End -->
    ...
    <script src="lib/owlcarousel/owl.carousel.min.js"></script>
	 <script>
		function confirmation(index){
			  var recipeID = $("#recipeID-" + index).val();
			 
			  console.log(recipeID);
			  var r = confirm("Are you sure you want to delete?");
			  if (r == true) {				 		  
				  location.href = 'RecipeController?action=deletePersonalRecipe&recipeID=' + recipeID +'&userID=' + <c:out value="${sessionId}"/>;
    ...
    <script>
		function searchRecipes() {
		    ...
		    cardContainer = document.getElementById("tab-1");
		    cards = cardContainer.getElementsByClassName("col-md-6 col-lg-3");
		    
		    for (i = 0; i < cards.length; i++) {
		        title = cards[i].querySelector(".event-img h6");
