...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8">
        <title>Plan n Plate - Recipe4Every1</title>
        ...
        <div class="container-fluid event py-6">
            <div class="container">
                <div class="text-center wow bounceInUp" data-wow-delay="0.1s">
                    <small class="d-inline-block fw-bold text-dark text-uppercase bg-light border border-primary rounded-pill px-4 py-1 mb-3">Choose Recipes</small>
							        	...
							        	<div class="col-md-6 col-lg-3 wow bounceInUp" data-wow-delay="0.1s">
							        		<div class="event-img position-relative">
							        			...
							        			<div >
							        				...
							        				<a href="RecipeController?action=viewRecipe&recipeID=<c:out value="${recipe.recipeID}" />" class="btn btn-warning">View</a>
							        			</div>	
							        		</div>
							        	</div>
				                    </c:forEach>
