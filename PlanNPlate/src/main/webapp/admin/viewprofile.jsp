							...
							<div class="card">
								<div class="card-header">
									<div
										...
										<a
											href="AdminController?action=list&adminID=<c:out value="${sessionScope.sessionId}" /> "
								...
								<div class="card-body">
									...
									<div class="row mb-3">
										<div class="col-12">
											<a
												href="AdminController?action=update&adminID=<c:out value="${sessionScope.sessionId}" />"
