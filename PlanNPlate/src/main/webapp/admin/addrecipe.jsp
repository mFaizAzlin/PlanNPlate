							...
							<div class="card">
								<div class="card-header">
									<div
										...
										<form id="recipeForm" action="AdminRecipeController"
								...
								<div class="card-body">
									...
									<div class="mb-3">
										<label for="tag" class="form-label">Tag</label> <input
											type="text" class="form-control" name="tag"
											placeholder="Fill Tag">
									</div>
									<div class="row">
										<div class="col-lg-6 col-md-12 mb-3">
											<label for="ingredient" class="form-label">Ingredient</label>
											<textarea class="form-control" name="ingredient"
												placeholder="Fill Ingredient"
												style="width: 100%; height: 300px; resize: none;"></textarea>
										</div>
										<div class="col-lg-6 col-md-12 mb-3">
											<label for="instruction" class="form-label">Instruction</label>
											<textarea class="form-control" name="instruction"
												placeholder="Fill Instruction"
												style="width: 100%; height: 300px; resize: none;"></textarea>
										</div>
									</div>
