							...
							<div class="card">
								<div class="card-header">
									<div
										...
										<a href="AdminRecipeController?action=listRecipeAdmin&adminID=<c:out value="${sessionId}" />"
								...
								<div class="card-body">
									...
									<div class="row mb-3">
										<div class="col-2">
											<label for="recipename" class="form-label">Tag</label>:
										</div>
										<div class="col-10">
											<p class="form-control-plaintext">
												<c:out value="${recipe.tag}" />
											</p>
										</div>
									</div>
									<div class="row mb-3">
										<div class="col-2">
											<label for="email" class="form-label">Ingredient</label>:
										</div>
										<div class="col-10">
											<p class="form-control-plaintext">
									...
									<div class="row mb-3">
										<div class="col-2">
											<label for="password" class="form-label">Instruction</label>:
										</div>
										<div class="col-10">
											<p class="form-control-plaintext">
									...
									<div class="row mb-3">
										<div class="col-2">
											<label for="adminID" class="form-label">Upload by</label>:
										</div>
										<div class="col-10">
											<p class="form-control-plaintext">
									...
									<div class="row mb-3">
										<div class="col-12">
											<a
												href="AdminRecipeController?action=updateRecipeAdmin&recipeID=<c:out value="${recipe.recipeID}" />&userID=<c:out value='${recipe.userID}' />&adminID=<c:out value="${sessionScope.sessionId}" />"
												class="btn btn-warning btn float-start">Edit </a>
										</div>
									</div>
								</div>
							</div>
