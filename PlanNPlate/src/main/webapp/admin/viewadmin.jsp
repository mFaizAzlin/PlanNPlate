			...
			<div class="sidebar-wrapper scrollbar scrollbar-inner">
				<div class="sidebar-content">
					<ul class="nav nav-secondary">
						...
						<li class="nav-item"><a
							href="AdminRecipeController?action=listRecipeAdmin&adminID=<c:out value="${sessionId}" />"> <i
							...
							<div class="card">
								...
								<div class="card-body">
									<div class="row mb-3">
										...
										<div class="col-10">
											<img
												src="data:image/jpg;base64,<c:out value="${view.image}" />"
